...
/**
 * Servlet implementation class SelectStudentMapAllServlet
 */
@WebServlet("/student/selectStudentMapAll.do")
public class SelectStudentMapAllServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Map> student=new StudentService().selectStudentAllMap();
